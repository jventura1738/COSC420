...
prefix=/usr
exec_prefix=/usr
sysconfdir=/etc/mpich-3.2-x86_64
includedir=/usr/include/mpich-3.2-x86_64
libdir=/usr/lib64/mpich-3.2/lib
...
final_cflags=" -m64 -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches   -m64 -mtune=generic -fPIC"
final_cppflags=" "
final_ldflags=" -Wl,-z,noexecstack"
final_libs=""
if test "yes" = "no" -o "${interlib_deps}" = "no" ; then
    final_ldflags="${final_ldflags} -Wl,-z,noexecstack"
